...
/*A function to return the summation of the linked list elements*/
int LinkedListSum(Node_t *StartAddress);
...
{
	/*Defining Variables*/
	int LinkedListSize, InsertionNumber, NumberPosition, Sum;
	...
	Sum = LinkedListSum(Linked);
	printf("Summation of the elements is: %d", Sum);
...
int LinkedListSum(Node_t *StartAddress)
{
	...
	/*Return summation of the data of linked list*/
	return Sum;
}
